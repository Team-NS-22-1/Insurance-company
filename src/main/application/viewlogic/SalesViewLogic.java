...
public class SalesViewLogic implements ViewLogic {
            ...
            if (insurance == null) {
                ...
                switch (insurance.getInsuranceType()) {
                    case HEALTH:
                        ...
                        premium = insuranceList.readPremium(insurance.getId());
                        ...
                        switch (command) {
                            ...
                            case 1:
                                ...
                                contract.setInsuranceId(insurance.id)
                                        .setPremium(premium)
                                ...
                                registerCustomerInfo(insurance.getId(), contract);
                                break;
                            // 취소
                            case 2:
                                isLoop = false;
    ...
    private void registerCustomerInfo(int insuranceId, Contract contract) {
